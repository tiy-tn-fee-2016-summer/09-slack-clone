...
// So, you will have to use `.cloneNode(true)` before appending the node
// to get a copy of the child elements that you can then move
//
...
var li = existingList.querySelectorAll('li');
